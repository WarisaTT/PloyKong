<template>
  <section class="pub-certs pub-section" :class="'layout-' + (data.layout || 'centered')" :style="data.section_bg_color ? `background: ${data.section_bg_color} !important; --item-bg: ${data.section_bg_color};` : ''">
